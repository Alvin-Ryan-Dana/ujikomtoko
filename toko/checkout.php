        ...
        <h2>Keranjang Belanja</h2>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="metode_pembayaran" id="cod" value="Bayar di Tempat" required>
            ...
            <?php
                if (isset($_POST["checkout"])) {
                    ...
                    // Menyimpan data ke tabel hist
                    $koneksi->query("INSERT INTO hist 
                        (id_customer,id_ongkir,tanggal, kota, tarif, total, metode_pembayaran, alamat_kirim) 
                        VALUES ('$id_pelanggan','$id_ongkir','$tanggal_pembelian', '$nama_kota', '$tarif', '$total_pembelian', '$metode_pembayaran', '$alamat_pengiriman')");
